...
import { MapPin, Plus, User, Calendar, LogOut, History, ChevronDown, Users, CalendarDays } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-background border-b border-border/30 px-6 py-4 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 flex items-center justify-center transition-all duration-300 group-hover:scale-105">
            <img src="https://i.ibb.co/9mdV4RNZ/o-Fqnid5-X-400x400.jpg" alt="Superteam India Logo" className="w-10 h-10 transition-transform duration-300 group-hover:scale-110" />
          </div>
          <span className="text-xl font-bold text-white group-hover:text-primary/90 transition-colors duration-300">

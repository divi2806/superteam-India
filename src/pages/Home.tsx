            ...
            <div className="glass-dark rounded-lg p-5">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-3 p-2.5 rounded-md bg-secondary/50">
                  ...
                  <span className="text-sm text-muted-foreground">Simple registration process</span>
                </div>
                <div className="flex items-center space-x-3 p-2.5 rounded-md bg-secondary/50">
                  <div className="w-2.5 h-2.5 rounded-full bg-amber-400"></div>
                  <span className="text-sm text-muted-foreground">Create & manage your events</span>
                </div>
              </div>
            </div>
          </div>

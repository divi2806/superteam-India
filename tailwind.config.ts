	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'grid-pattern': 'linear-gradient(to right, rgb(64, 64, 64, 0.05) 1px, transparent 1px), linear-gradient(to bottom, rgb(64, 64, 64, 0.05) 1px, transparent 1px)',
			},
			keyframes: {
				'accordion-down': {
					from: {
